...
corps_urlpatterns = [
    ...
    path("<int:pk>/update/", view=corps_views.corps_update_view,
         name="update"),
    path("<int:pk>/delete/", view=corps_views.corps_delete_view,
         name="delete"),
]
...
grades_urlpatterns = [
    ...
    path("<int:pk>/update/",
         view=grades_views.grades_update_view,
         name="update"),
    path("<int:pk>/delete/",
         view=grades_views.grades_delete_view,
         name="delete"),
]
...
ministers_urlpatterns = [
    ...
    path("<int:pk>/update/",
         view=ministers_views.ministers_update_view,
         name="update"),
    path("<int:pk>/delete/",
         view=ministers_views.ministers_delete_view,
         name="delete"),
]
...
paying_orgs_urlpatterns = [
    ...
    path("create/",
         view=paying_orgs_views.paying_orgs_create_view,
         name="create"),
    path("<int:pk>/update/",
         view=paying_orgs_views.paying_orgs_update_view,
         name="update"),
    path("<int:pk>/delete/",
         view=paying_orgs_views.paying_orgs_delete_view,
         name="delete"),
]

request_categories_urlpatterns = [
    path("list/",
         view=request_category_views.request_categories_list_view,
         name="list"),
    path("create/",
         view=request_category_views.request_categories_create_view,
         name="create"),
    path("<int:pk>/update/",
         view=request_category_views.request_categories_update_view,
         name="update"),
    path("<int:pk>/delete/",
         view=request_category_views.request_categories_delete_view,
         name="delete"),
]

document_categories_urlpatterns = [
    path("list/",
         view=document_category_views.document_categories_list_view,
         name="list"),
    path("create/",
         view=document_category_views.document_categories_create_view,
         name="create"),
    path("<int:pk>/update/",
         view=document_category_views.document_categories_update_view,
         name="update"),
    path("<int:pk>/delete/",
         view=document_category_views.document_categories_delete_view,
         name="delete"),
]
...
prepayments_table_urlpatterns = [
    path("list/",
         view=prepayments_table_views.prepayments_table_list_view,
         name="list"),
    path("create/",
         view=prepayments_table_views.prepayments_table_create_view,
         name="create"),
    path("<int:pk>/update/",
         view=prepayments_table_views.prepayments_table_update_view,
         name="update"),
    path("<int:pk>/delete/",
         view=prepayments_table_views.prepayments_table_delete_view,
         name="delete"),
]
...
urlpatterns = [
    ...
    path('grades/', include((grades_urlpatterns, app_name),
                            namespace='grades')),
    path('api/v1/', include((urlpatterns, app_name), namespace='api:v1')),
    path('ministers/',
         include((ministers_urlpatterns, app_name), namespace='ministers')),
    path('paying-orgs/',
         include((paying_orgs_urlpatterns, app_name),
                 namespace='paying_orgs')),
    path(
        'prepayments-table/',
        include((prepayments_table_urlpatterns, app_name),
                namespace='prepayments_table')),
    path(
        'request-categories/',
        include((request_categories_urlpatterns, app_name),
                namespace='request_categories')),
    path(
        'document-categories/',
        include((document_categories_urlpatterns, app_name),
                namespace='document_categories')),
]
